...
function OtrosGastosDirectos(props) {
    ...
    let gastoAlimentacionP = (parseFloat(props.gastoAlimentacion) / parseFloat(props.ingresoLeche) * 100).toFixed(1);
    let gastoSuministroP = (parseFloat(props.gastoSuministro)/ parseFloat(props.ingresoLeche) * 100).toFixed(1);
    let gastosVeterinariaP = (parseFloat(props.gastosVeterinaria)/ parseFloat(props.ingresoLeche) * 100).toFixed(1);
    let gastosRodeoP = (parseFloat(props.gastosRodeo)/ parseFloat(props.ingresoLeche) * 100).toFixed(1);
    let alquilerVacasP = (parseFloat(props.alquilerVacas)/ parseFloat(props.ingresoLeche) * 100).toFixed(1);
    let gastosTamboP = (parseFloat(props.gastosTambo)/ parseFloat(props.ingresoLeche) * 100).toFixed(1);
