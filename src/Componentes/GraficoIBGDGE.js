...
function GraficoIBGDGE(props) {
    ...
    useEffect (() => {
        ...
        if (props.graficosEnMoneda === false) {
            ...
            setGastosDirectos((parseFloat(props.gastosDirectos)/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setGastosEstructura((parseFloat(props.gastosEstructura)/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setUnidad('% sobre IB');
        }
    ...
    return (
        <div className='resultados'>
            ...
            <Comentario anchorSelect="#aplicacionIB2" place="top" style={{ zIndex: 99 }}>
                ...
                <p>La sección verde indica lo que queda como RESULTADO OPERATIVO (RO)</p>
            </Comentario>
