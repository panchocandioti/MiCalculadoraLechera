...
function ReportePDF(props) {
    ...
    const [ingresoBruto, setIngresoBruto] = useState(props.ingresoBruto2);
    ...
    const [precioVacas, setPrecioVacas] = useState(props.precioVacas);
    const [precioToros, setPrecioToros] = useState(props.precioToros);
    const [precioToritos, setPrecioToritos] = useState(props.precioToritos);
    const [precioTerneros, setPrecioTerneros] = useState(props.precioTerneros);
    const [precioTerneras, setPrecioTerneras] = useState(props.precioTerneras);
    const [precioVqLitros, setPrecioVqLitros] = useState(props.precioVqLitros);
    const [cabezasVendidas, setCabezasVendidas] = useState(props.cabezasVendidas);
    const [diferenciaInventario, setDiferenciaInventario] = useState(props.diferenciaInventario);
    const [diferenciaInventarioLitro, setDiferenciaInventarioLitro] = useState(props.diferenciaInventarioLitro);
    const [vacasMuertas, setVacasMuertas] = useState(props.vacasMuertas);
    const [mortandadVacas, setMortandadVacas] = useState(props.mortandadVacas);
    const [cantidadVqReposicion, setCantidadVqReposicion] = useState(props.cantidadVqReposicion);
    ...
    useEffect(() => {
        setIngresoBruto((prevState) => props.ingresoBruto2)
    }, [props.ingresoBruto2]);
    ...
    }, [props.cabezasVendidas]);

    useEffect(() => {
        setDiferenciaInventario((prevState) => props.diferenciaInventario)
    }, [props.diferenciaInventario]);

    useEffect(() => {
        setDiferenciaInventarioLitro((prevState) => props.diferenciaInventarioLitro)
    }, [props.diferenciaInventarioLitro]);

    useEffect(() => {
        setVacasMuertas((prevState) => props.vacasMuertas)
    }, [props.vacasMuertas]);

    useEffect(() => {
        setMortandadVacas((prevState) => props.mortandadVacas)
    }, [props.mortandadVacas]);

    useEffect(() => {
        setCantidadVqReposicion((prevState) => props.cantidadVqReposicion)
    }, [props.cantidadVqReposicion]);

    useEffect(() => {
        setBajaVacasP((prevState) => props.bajaVacasP)
    }, [props.bajaVacasP]);

    useEffect(() => {
        setPrecioVacas((prevState) => props.precioVacas)
    }, [props.precioVacas]);

    useEffect(() => {
        setPrecioToros((prevState) => props.precioToros)
    }, [props.precioToros]);

    useEffect(() => {
        setPrecioToritos((prevState) => props.precioToritos)
    }, [props.precioToritos]);

    useEffect(() => {
        setPrecioTerneros((prevState) => props.precioTerneros)
    }, [props.precioTerneros]);

    useEffect(() => {
        setPrecioTerneras((prevState) => props.precioTerneras)
    }, [props.precioTerneras]);

    useEffect(() => {
        setPrecioVqLitros((prevState) => props.precioVqLitros)
    }, [props.precioVqLitros]);

    useEffect(() => {
        setCostoVaquillona((prevState) => props.costoVaquillona)
    }, [props.costoVaquillona]);
            ...
            <Page size="A4">
                <View>
                    ...
                    <View style={styles.table}>
                        ...
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                                <Text>Precios venta</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(precioVacas)} {codigoMoneda}/kg</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(precioToros)} {codigoMoneda}/kg</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(precioToritos)} {codigoMoneda}/kg</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(precioTerneros)} {codigoMoneda}/kg</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(precioTerneras)} {codigoMoneda}/kg</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(precioVqLitros)} litros/cab</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.table}>
                    ...
                    <View style={styles.table}>
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                                <Text>Vacas muertas</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(vacasMuertas)} cabezas/año</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>Vaquillonas de reemplazo</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(cantidadVqReposicion)} cabezas/año</Text>
                            </View>
                        </View>
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                                <Text>Mortandad de vacas</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(mortandadVacas)} % anual</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>Reposición</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(porcentajeReposicion)} % anual</Text>
                            </View>
                        </View>
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                        ...
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                                <Text>Baja de vacas</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(bajaVacasP)} % anual</Text>
                            </View>
                            <View style={styles.tableCell}>
                        ...
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                                <Text>Crecimiento del rodeo</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(variacionRodeoP)} % anual</Text>
                            </View>
                            <View style={styles.tableCell}>
                    ...
                    <View style={styles.table}>
                        ...
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                                <Text>Variación de rodeo</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format(diferenciaInventario)} {codigoMoneda}/año</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format((parseFloat(diferenciaInventario) / 12).toFixed(0))} {codigoMoneda}/mes</Text>
                            </View>
                            <View style={styles.tableCell}>
                                <Text>{new Intl.NumberFormat().format((parseFloat(diferenciaInventario) / parseFloat(ingresoBruto) * 100).toFixed(1))}%</Text>
                            </View>
                        </View>
                        <View style={styles.tableRow}>
                            <View style={styles.tableCell}>
                    ...
                    <Text style={styles.plaintext}>(2) Costo de la vaquillona al parir: {new Intl.NumberFormat().format((parseFloat(costoVaquillona)).toFixed(0))} litros/cabeza</Text>
                </View>
            ...
            <Page size="A4">
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={styles.tableCell}>
                            <Text>{new Intl.NumberFormat().format(parseFloat(ingresoCarne) / parseFloat(lecheVendida))} {codigoMoneda}/litro</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCell}>
                            <Text>Recupero por venta de vaquillonas</Text>
                        </View>
                        <View style={styles.tableCell}>
                            <Text>{new Intl.NumberFormat().format(parseFloat(ingresoVq) / parseFloat(lecheVendida))} {codigoMoneda}/litro</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCell}>
                            <Text>Recupero por variación de rodeo</Text>
                        </View>
                        <View style={styles.tableCell}>
                            <Text>{new Intl.NumberFormat().format(parseFloat(diferenciaInventario) / parseFloat(lecheVendida))} {codigoMoneda}/litro</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCell}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={styles.tableCell}>
                            <Text>{new Intl.NumberFormat().format(parseFloat(precioLeche))} {codigoMoneda}/litro</Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableCell}>
