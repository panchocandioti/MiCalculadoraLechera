...
function GraficoAplicacionIB(props) {
    ...
    useEffect (() => {
        ...
        if (graficosEnMoneda === false) {
            setResultadoOperativo((parseFloat(props.resultadoOperativo)/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setGastoManoDeObra((parseFloat(props.gastoManoDeObra)/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setGastoReposicion((parseFloat(props.gastoReposicion)/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setAlimentacionSuministro(((parseFloat(props.gastoAlimentacion) + parseFloat(props.gastoSuministro))/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setVeterinariaRodeo(((parseFloat(props.gastosVeterinaria) + parseFloat(props.gastosRodeo))/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setAlquileres(((parseFloat(props.alquilerVacas) + parseFloat(props.gastoArrendamiento))/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setGastosTambo((parseFloat(props.gastosTambo)/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setOtrosGastosEstructura(((parseFloat(props.impuestos) + parseFloat(props.gastosAdministracion) + parseFloat(props.gerencia))/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setGastosMantenimiento((parseFloat(props.gastosMantenimiento)/parseFloat(props.ingresoBruto2)*100).toFixed(1));
            setUnidad('% sobre IB');
        }
    ...
    return (
        <div className='resultados'>
            ...
            <Comentario anchorSelect="#aplicacionIB" place="top" style={{ zIndex: 99 }}>
                ...
                <p>La sección verde indica lo que queda como RESULTADO OPERATIVO</p>
            </Comentario>
